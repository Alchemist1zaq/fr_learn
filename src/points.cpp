...
vector<double> getPts1D(string ptsType, int order) {
  ...
  if (!ptsType.compare("Equidistant")) {
    ...
    if (order == 0) {
      ...
      stringstream ss;
      ss << order;
      string errMsg = "Gauss-Ledgendre point locations for order " + ss.str() +
                      " not implemented.";
    ...
    if (order == 0) {
      ...
      stringstream ss;
      ss << order;
      string errMsg = "Gauss-Lobatto point locations for order " + ss.str() +
                      " not implemented.";
      fatalError(errMsg.c_str());
    }
  } else {
...
vector<double> getQptWeights(int order, int nDims) {
  ...
  if (nDims == 2) {
    ...
    for (int i = 0; i < order + 1; i++) {
      for (int j = 0; j < order + 1; j++) {
        for (int k = 0; k < order + 1; k++) {
          outWts[k + (order + 1) * (j + i * (order + 1))] =
              qwts1D[i] * qwts1D[j] * qwts1D[k];
        }
      }
    }
  }
...
vector<double> getQptWeights1D(int order) {
  ...
  if (order == 0) {
    ...
    ss << order;
    string errMsg =
        "Gauss quadrature weights for order " + ss.str() + " not implemented.";
    fatalError(errMsg.c_str());
  }
...
void getQuadRuleTet(int order, vector<point> &locQpts,
  ...
  case 4: {
    ...
    weights = {wt1, wt1, wt1, wt1, wt2, wt2, wt2,
               wt2, wt3, wt3, wt3, wt3, wt3, wt3};
    break;
  }
  case 6: {
    locQpts.resize(24);
    ...
    double wt4 = 27. / 560.;
    weights = {wt1, wt1, wt1, wt1, wt2, wt2, wt2, wt2, wt3, wt3, wt3, wt3,
  ...
  case 8: {
    ...
    weights = {wt1, wt1, wt1, wt1, wt2, wt2, wt2, wt2, wt3, wt3, wt3, wt3,
               wt4, wt4, wt4, wt4, wt5, wt5, wt5, wt5, wt5, wt5, wt6, wt6,
               wt6, wt6, wt6, wt6, wt6, wt6, wt6, wt6, wt6, wt6, wt7, wt7,
               wt7, wt7, wt7, wt7, wt7, wt7, wt7, wt7, wt7, wt7};
    break;
  }
  case 10: {
    locQpts.resize(79);
    ...
    weights = {wt1,  wt2,  wt2,  wt2,  wt2,  wt3,  wt3,  wt3,  wt3,  wt4,
               wt4,  wt4,  wt4,  wt5,  wt5,  wt5,  wt5,  wt5,  wt5,  wt6,
               wt6,  wt6,  wt6,  wt6,  wt6,  wt6,  wt6,  wt6,  wt6,  wt6,
               wt6,  wt7,  wt7,  wt7,  wt7,  wt7,  wt7,  wt7,  wt7,  wt7,
               wt7,  wt7,  wt7,  wt8,  wt8,  wt8,  wt8,  wt8,  wt8,  wt8,
               wt8,  wt8,  wt8,  wt8,  wt8,  wt9,  wt9,  wt9,  wt9,  wt9,
               wt9,  wt9,  wt9,  wt9,  wt9,  wt9,  wt9,  wt10, wt10, wt10,
               wt10, wt10, wt10, wt10, wt10, wt10, wt10, wt10, wt10};
    break;
  }
  default: {
    stringstream ss;
    ss << order;
    string errMsg = "Tetrahedron quadrature rules for order " + ss.str() +
                    " not implemented.";
    fatalError(errMsg.c_str());
  }
  }
...
void getQuadRuleTri(int order, vector<point> &locQpts,
                    vector<double> &weights) {
  /* Linbo Zhang, Tau Cui and Hui Liu, "A Set of Symmetric Quadrature Rules on
   * Triangles and Tetrahedra." J. Comp. Math., 2009.
   * See also lsec.cc.ac.cn/phg to obtain source files containing explicit
  ...
  case 4: {
    locQpts.resize(6);
    double loc1 =
        .4459484909159649; // = (8-sqrt(10)+sqrt(38-44*sqrt(2/5))) / 18
    double loc2 = 1 - 2. * loc1;
    locQpts[0] = point({loc2, loc1, 0.});
    locQpts[1] = point({loc1, loc2, 0.});
    locQpts[2] = point({loc1, loc1, 0.});
    ...
    locQpts[5] = point({loc1, loc1, 0.});
    double wt1 =
        .2233815896780115; // = (620 + sqrt(213125 - 53320 * sqrt(10))) / 3720
    double wt2 =
        .1099517436553219; // = (620 - sqrt(213125 - 53320 * sqrt(10))) / 3720
    weights = {wt1, wt1, wt1, wt2, wt2, wt2};
    break;
  }
  case 5: {
  ...
  case 7: {
    ...
    weights = {wt1, wt1, wt1, wt2, wt2, wt2, wt3, wt3,
               wt3, wt4, wt4, wt4, wt4, wt4, wt4};
    break;
  }
  case 8: {
    locQpts.resize(16);
    ...
    weights = {wt0, wt1, wt1, wt1, wt2, wt2, wt2, wt3,
               wt3, wt3, wt4, wt4, wt4, wt4, wt4, wt4};
    break;
  }
  case 10: {
    locQpts.resize(25);
  ...
  default: {
    ...
    ss << order;
    string errMsg =
        "Triangle quadrature rules for order " + ss.str() + " not implemented.";
    fatalError(errMsg.c_str());
  }
  }
}
