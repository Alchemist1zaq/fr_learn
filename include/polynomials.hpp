...
/*! Evaluate the first derivative of the 1D Lagrange polynomial mode based on
 * points x_lag at point y */
double dLagrange(vector<double> &x_lag, double y, uint mode);

/*! Evaluate the second derivative of the 1D Lagrange polynomial mode based on
 * points x_lag at point y */
double ddLagrange(vector<double> &x_lag, double y, uint mode);

/*! Evaluate the 1D Legendre polynomial mode number in_mode based at point
 * location in_r*/
double Legendre(double in_r, int in_mode);

/*! Evaluate the derivative of the 1D Legendre polynomial mode number in_mode
 * based at point location in_r*/
double dLegendre(double in_r, int in_mode);

/*! Evaluate the 2D Legendre polynomial mode number in_mode based at point
 * location in_r*/
...
/*! Evaluate the divergence [dF/dxi or dG/deta] of the correction function at a
 * point */
